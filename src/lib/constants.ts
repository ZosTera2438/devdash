...
export const pricingCards = [
  {
    title: 'Starter',
    description: 'Perfect for trying out devdash',
    price: 'Free',
    duration: '',
  ...
  },
  {
    ...
    priceId: 'price_1OpB4KSHEwoVVEiqflWl7mNL',
  },
  {
    title: 'Basic',
    ...
    priceId: 'price_1OpB2CSHEwoVVEiq4wdYcFou',
  },
]

export const addOnProducts = [
  { title: 'Priority Support', id: 'prod_PeUEIjo5aceRUM' },
]
